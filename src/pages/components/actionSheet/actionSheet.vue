<template>
  <hy-config-provider :custom-style="themeColor" :theme="darkMode">
    <hy-cell :list="list" @click="onChange"></hy-cell>

    <hy-action-sheet v-model="list[0].value" :actions="actions" @select="onClick"></hy-action-sheet>
    <hy-action-sheet
...
import { IActionSheetAction, IActionSheetPanel } from '@/package/components/hy-action-sheet/typing'
